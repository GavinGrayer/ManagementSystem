 ...
 %>
        ...
        <div class="tpl-content-wrapper">
            <div class="row-content am-cf">
              ...
              <option value="option1">请选择请假类型</option>
              <option value="option2">外出</option>
              <option value="option3">签卡</option>
              <option value="option3">出差</option>
              <option value="option3">加班</option>
			  <option value="option3">调休</option>
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" type="button"></button>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        ...
                                        <s:iterator value="attenceList" var="attence">
                                        
                                            <tr class="gradeX">
                                             	<td>${attence.name} </td>
                                                <td><fmt:formatDate value="${attence.startTime}" pattern="yyyy-MM-dd HH:mm:ss" /> </td>
                                                
                                                <td><fmt:formatDate value="${attence.endTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                <td>${attence.method}</td>
												<td>${attence.attencetype}</td>
												<td>${attence.reason}</td>
												<td>${attence.status}</td>
												<td>${attence.monitor}</td>
