            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 假期申请 <small>Amaze UI</small></div>
                        <p class="page-header-description">Holiday application</p>
                    </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="jqsqAction" method="post">
                                   

                                    <div class="am-form-group">
                                        <label for="user-email" class="am-u-sm-3 am-form-label">请假时限 <span class="tpl-form-line-small-title">Time</span></label>
                                        <div class="am-u-sm-9">
										...
										<table>
											<tr>
												<td>
													<input type="text" name="startTime" class="am-form-field tpl-form-no-bg" placeholder="起始时间" style="width:100px" data-am-datepicker="" readonly>
												</td>
											...
											<td>
												...
												<td>
													<input type="text" name="endTime" class="am-form-field tpl-form-no-bg" placeholder="结束时间"  style="width:100px" data-am-datepicker="" readonly>
												</td>
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-phone" class="am-u-sm-3 am-form-label">请假类别<span class="tpl-form-line-small-title">Author</span></label>
                                        <div class="am-u-sm-9">
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">请假时长 <span class="tpl-form-line-small-title">Method</span></label>
                                        <div class="am-u-sm-9">
											...
											<table>
												...
												<tr>
													<td>
														<input type="text" name="day" placeholder="天" style="width:100px">
													</td>
													...
													<td>
														<input type="text" name="hour" placeholder="小时" style="width:100px">
													</td>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea name="reason" class="" rows="10" id="user-intro" placeholder="请输入请假原因"></textarea>
                                        </div>
                                    </div>
