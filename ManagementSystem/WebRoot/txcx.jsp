            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" type="button"></button>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        ...
                                        <s:iterator value="txsqList" var="txsq">
                                        
                                            <tr class="gradeX">
                                             	<td>${txsq.txsqname} </td>
                                                <td><fmt:formatDate value="${txsq.txsqtime}" pattern="yyyy-MM-dd HH:mm:ss" /> </td>
                                                
                                                <td><fmt:formatDate value="${txsq.txtime}" pattern="yyyy-MM-dd" /></td>
                                                <td>${txsq.txmethod}</td>
												<td>调休</td>
												<td>${txsq.reason}</td>
												<td>同意</td>
