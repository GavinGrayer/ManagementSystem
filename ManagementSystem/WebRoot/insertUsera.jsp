                        ...
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <div class="am-u-sm-12">
	                                  ...
	                                  <form id="userupdateform" action="userupdateAction" method="post">  
	                                    ...
	                                    <table id="sjzdquery"   width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
	                                        ...
	                                        <s:iterator value="peopArrayList" var="people">
	                                        
	                                            <tr style="text-align:center;" class="gradeX">
	                                            	<!-- <td>${sjzd.sjzdid} </td> -->
	                                             	<td  width="400px"> ${people.username} </td>
	                                             	 <td  width="400px"> ${people.password} </td>                             
	                       
	
	                                                <td>
	                                                    <div class="tpl-table-black-operation">
	                                                        <a id="edit" href="javascript:;"value="${people.username}" ><i class="am-icon-pencil"></i>编辑</a>
	                                                        <a href="javascript:;" class="tpl-table-black-operation-del"><i class="am-icon-trash"></i>删除</a>
	                                                    </div>
	                                                </td>
	                                            </tr>
                                ...
                                <!-- 
                                 ...
                                 <form id="insertUseraform" action="insertUseraAction" method="post">
                                    ...
                                    <caption>请在下面添加</caption>
                                       <thead>
	                                       ...
	                                       <input type="hidden" id="content" name="flag" value="0"/>
                                        
                                            <tr  class="gradeX">
                                             	<td><input class="tpl-header-search-box" type="text" style="width:100px" placeholder="请输入员工姓名..." name="username"></td>                                  
                                               <td><input class="tpl-header-search-box" type="text" style="width:100px" placeholder="请输入员工密码..." name="password"></td>
    		...
    		$("#sjzdquery div a").click(function(){
    			...
    			*/
    			...
    			if(n=="删除"){
    				...
    				username= $(this).prev("a").attr("value");
    			
    				console.log("删除..."+username);
    				 $("#username").val(username);
    	
    				//$("#sjzdupdateform").submit();
    				$(this).attr("href","deleteUseraAction?username="+username);
