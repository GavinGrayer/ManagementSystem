            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 出差申请<small>Amaze UI</small></div>
                        <p class="page-header-description">Travel application</p>
                    </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="ccsqAction" method="post">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">出差天数 <span class="tpl-form-line-small-title">Days</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="methodday" class="tpl-form-input" id="user-name" placeholder="请输入标题文字">
                                            <small>出差天数为必填。</small>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <label for="user-email"  class="am-u-sm-3 am-form-label">出差日期 <span class="tpl-form-line-small-title">Time</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="day" class="am-form-field tpl-form-no-bg" placeholder="出差日期" data-am-datepicker="" readonly>
                                            <small>出差日期为必填</small>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <label for="user-phone" class="am-u-sm-3 am-form-label">出行方式 <span class="tpl-form-line-small-title">ways</span></label>
                                        <div class="am-u-sm-9">
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-phone" class="am-u-sm-3 am-form-label">出行人员 <span class="tpl-form-line-small-title">people</span></label>
                                        <div class="am-u-sm-9">
                                            <select name="type" multiple="multiple" data-am-selected="{searchBox: 0}" style="display: none;">
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">目的地 <span class="tpl-form-line-small-title">Destination</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="distination" placeholder="输入目的地">
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-intro" class="am-u-sm-3 am-form-label">出差事由</label>
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" name="reason" id="user-intro" placeholder="请输入出差事由"></textarea>
                                        </div>
                                    </div>
