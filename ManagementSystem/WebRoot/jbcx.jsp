            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" type="button"></button>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        ...
                                        <s:iterator value="jbsqList" var="jbsq">
                                        
                                            <tr class="gradeX">
                                             	<td>${jbsq.jbsqname} </td>
                                                <td><fmt:formatDate value="${jbsq.jbsqtime}" pattern="yyyy-MM-dd HH:mm:ss" /> </td>
                                                
                                                <td><fmt:formatDate value="${jbsq.jbtime}" pattern="yyyy-MM-dd" /></td>
                                                <td>${jbsq.method}</td>
												<td>加班</td>
												<td>${jbsq.reason}</td>
												<td>同意</td>
