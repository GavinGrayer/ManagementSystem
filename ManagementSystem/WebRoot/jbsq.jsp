            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 加班申请 <small>Amaze UI</small></div>
                        <p class="page-header-description">Overtime Application</p>
                    </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="jbsqAction" method="post">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">申请日期 <span class="tpl-form-line-small-title">Today</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="today" class="tpl-form-input" id="today" placeholder="点击自动填写申请日期" value="">
                                            <small>请点击自动填写申请日期</small>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <label for="user-email" class="am-u-sm-3 am-form-label">加班日期 <span class="tpl-form-line-small-title">Time</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="overtime" class="am-form-field tpl-form-no-bg" placeholder="加班日期" data-am-datepicker="" readonly>
                                            <small>加班日期为必填</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">加班时长 <span class="tpl-form-line-small-title">Time</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="method" placeholder="加班时长">个工作日
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-intro" class="am-u-sm-3 am-form-label">加班原因</label>
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" name="reason" id="user-intro" placeholder="请输入加班原因"></textarea>
                                        </div>
                                    </div>
